...
<div class="card shadow-sm">
    <div class="card-header">
        <h5 class="mb-0 fw-semibold">Novo Cliente</h5>
    </div>
    <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control <?= isset($errors['nome']) ? 'is-invalid' : '' ?>" 
                           ...
                           value="<?= $this->e($old['nome'] ?? '') ?>" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="cep" name="cep" 
                           placeholder="00000-000" value="<?= $this->e($old['cep'] ?? '') ?>">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-8 mb-3">
                    ...
                    <input type="text" class="form-control" id="endereco" name="endereco" 
                           placeholder="Rua, número, complemento" value="<?= $this->e($old['endereco'] ?? '') ?>">
                </div>
                <div class="col-md-4 mb-3">
                    <label for="cidade" class="form-label">Cidade</label>
                    <input type="text" class="form-control" id="cidade" name="cidade" 
                           placeholder="Nome da cidade" value="<?= $this->e($old['cidade'] ?? '') ?>">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="estado" name="estado" 
                           placeholder="UF" maxlength="2" value="<?= $this->e($old['estado'] ?? '') ?>">
                </div>
            </div>
